...
<div className="maincontainer">
        ...
        <div id="Lparent1">
          <h1 className="side side2">Fitness</h1>
    ...
    <div className="middlecontainerright">
        ...
        <div className="Rparent1">
          ...
          {received
            .filter(
              (item) => item.id === 49 && item.Category === "Fitness"
            )
            .map((item, index) => {
              return (
          ...
          {received
            .filter(
              (item) => item.id >= 42 && item.id <= 46 && item.Category === "Fitness"
            )
            .map((item, index) => {
              return (
                <div id="parent2" key={index}>
        ...
        {received.filter((item)=>item.id===45).map((item,index)=>{
             return(
              <div key={index}>
                 <img
            src={item.image}
