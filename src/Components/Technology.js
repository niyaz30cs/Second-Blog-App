  ...
  return (
    <>
      ...
      <div className="maincontainer">
        ...
        <div id="Lparent1">
          <h1 className="side side2">Technology</h1>
        ...
        <div className="middlecontainerright">
          ...
          <div className="Rparent1">
            ...
            {received
              .filter(
                (item) => item.id === 29 && item.Category === "Technology"
              )
              .map((item, index) => {
                return (
            ...
            {received
              .filter(
                (item) => item.id >= 29 && item.id <= 33 && item.Category === "Technology"
              )
              .map((item, index) => {
                return (
                  <div id="parent2" key={index}>
          ...
          <div className="bigimage2">
            {received.filter((item) => item.id === 35).map((item, index) => {
              return (
                <div key={index}>
                  <img
                    src={item.image}
